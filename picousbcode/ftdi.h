...
#define FTDI_SIO_GET_MODEM_STATUS	0x05 /* Retrieve current value of modem status register */
#define FTDI_SIO_SET_EVENT_CHAR		0x06 /* Set the event character */
#define FTDI_SIO_SET_ERROR_CHAR		0x07 /* Set the error character */
#define FTDI_SIO_SET_LATENCY_TIMER	0x09 /* Set the latency timer */
...
#define FTDI_SIO_RESET_PUeRGE_RX 1
